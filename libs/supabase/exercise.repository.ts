...
export const FALLBACK_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    substitutes: [
      { exercise_id: '00000000-0000-0000-0000-000000000009', slug: 'cable-lateral-raise', name: 'Cable Lateral Raise', reason: 'Shoulder press rack taken: isolates lateral deltoid heads without spinal compression.' }
    ],
  ...
  },
  {
    ...
    secondary_muscles: ['Lats', 'Biceps', 'Rear Delts', 'Core'],
    movement_pattern: 'horizontal_pull',
    equipment_category: 'barbell',
    difficulty: 'intermediate',
    is_unilateral: false,
    setup_cue: 'Hinge forward at 45 degrees with flat spine. Grip slightly outside shoulder width.',
    execution_cue: 'Pull elbows toward hips until bar grazes lower abdomen. Squeeze upper back at peak, lower under control.',
    common_mistakes: ['Jerking torso upright during pull', 'Flaring elbows outward excessively', 'Rounding lumbar spine'],
    biomechanical_notes: 'Keeps shear load manageable on lumbar while maximizing middle trapezius and latissimus dorsi recruitment.',
    female_consideration: 'Chest-supported dumbbell row provides identical scapular retractor recruitment without lower back fatigue.',
    substitutes: [
      { exercise_id: '00000000-0000-0000-0000-000000000018', slug: 'chest-supported-row', name: 'Chest-Supported Row', reason: 'Lower back fatigued: eliminates spinal loading while targeting upper back.' }
    ],
    substitute_exercise_ids: ['00000000-0000-0000-0000-000000000018'],
    is_system: true,
    created_at: '2026-01-01T00:00:00Z',
  },
  {
    ...
    difficulty: 'intermediate',
    is_unilateral: false,
    setup_cue: 'Grip bar slightly wider than shoulder width with overhand grip. Depress shoulder blades before pulling.',
    execution_cue: 'Drive elbows down toward ribcage. Pull chest toward bar until chin clears bar. Lower under control to dead hang.',
    common_mistakes: ['Kicking legs or kipping', 'Incomplete range of motion', 'Shrugging shoulders into ears at top'],
    biomechanical_notes: 'Depressing scapulae before humeral adduction prevents rotator cuff impingement under vertical tensile load.',
    female_consideration: 'Lat pulldowns or band-assisted pull-ups allow micro-loading to build vertical pulling strength safely.',
    substitutes: [
      { exercise_id: '00000000-0000-0000-0000-000000000020', slug: 'lat-pulldown', name: 'Lat Pulldown', reason: 'Replicates vertical pull mechanics with scalable loading.' }
    ],
    substitute_exercise_ids: ['00000000-0000-0000-0000-000000000020'],
    is_system: true,
    created_at: '2026-01-01T00:00:00Z',
  },
  {
    ...
    substitutes: [
      { exercise_id: '00000000-0000-0000-0000-000000000002', slug: 'barbell-flat-bench-press', name: 'Barbell Flat Bench Press', reason: 'Dumbbells occupied: swap to barbell bench with 10% lower total volume.' }
    ],
  ...
  },
  {
    ...
    difficulty: 'beginner',
    is_unilateral: false,
    setup_cue: 'Pin elbows to ribs with chest slightly tilted forward.',
    execution_cue: 'Extend forearms down until elbows fully lock. Control return to 90 degrees.',
    common_mistakes: ['Elbows drifting forward and back', 'Using bodyweight to press down', 'Incomplete lockout'],
    biomechanical_notes: 'Keeps constant tension on the lateral and medial heads of the triceps brachii.',
    female_consideration: 'Rope attachment allows natural forearm pronation to ease wrist strain.',
    substitutes: [
      { exercise_id: '00000000-0000-0000-0000-000000000024', slug: 'overhead-cable-triceps-extension', name: 'Overhead Cable Triceps Extension', reason: 'Targets long head in stretched position.' }
    ],
    substitute_exercise_ids: ['00000000-0000-0000-0000-000000000024'],
    is_system: true,
    created_at: '2026-01-01T00:00:00Z',
  },
  {
    ...
    substitutes: [
      { exercise_id: '00000000-0000-0000-0000-000000000001', slug: 'barbell-back-squat', name: 'Barbell Back Squat', reason: 'Switch to free-weight squat when rack is available.' }
    ],
  ...
  },
  {
    ...
    secondary_muscles: ['Feet'],
    movement_pattern: 'isolation',
    equipment_category: 'machine',
    difficulty: 'beginner',
    is_unilateral: false,
    setup_cue: 'Balls of feet on block edge, knees straight but not hyperextended.',
    execution_cue: 'Lower heels into a full 2-second deep stretch, drive up onto big toes and hold peak for 1 second.',
    common_mistakes: ['Bouncing rapidly with Achilles elasticity', 'Bending knees to bounce load', 'Short half-reps'],
    biomechanical_notes: 'Straight knee orientation puts gastrocnemius under high mechanical tension compared to seated variations.',
    female_consideration: 'Can be performed holding a dumbbell on a step if machine is unavailable.',
    substitutes: [],
    substitute_exercise_ids: [],
    is_system: true,
    created_at: '2026-01-01T00:00:00Z',
  },
  {
    ...
    difficulty: 'beginner',
    is_unilateral: false,
    setup_cue: 'Lock thighs firmly under pads. Grip bar slightly wider than shoulder width.',
    execution_cue: 'Depress shoulder blades and drive elbows down to chest collarbone level with slight torso lean. Control eccentric back to full stretch.',
    common_mistakes: ['Swinging torso excessively backward', 'Pulling bar behind neck', 'Releasing tension at top'],
    biomechanical_notes: 'Direct latissimus dorsi adduction line of pull with zero lower-back shear forces.',
    female_consideration: 'Narrow parallel grip attachment offers optimal wrist and elbow joint comfort.',
    substitutes: [
      { exercise_id: '00000000-0000-0000-0000-000000000007', slug: 'pull-up', name: 'Pull-Up', reason: 'Bodyweight vertical pulling alternative.' }
    ],
    substitute_exercise_ids: ['00000000-0000-0000-0000-000000000007'],
    is_system: true,
    created_at: '2026-01-01T00:00:00Z',
  },
];
